...
import {
    ...
    Flex, FormControl, FormLabel, Input, Radio, RadioGroup, ModalFooter, useToast, Image, IconButton, Textarea, Tag
    ...
    return (
        <>
            <Button onClick={handleCreate}>
                ...
                <Modal isOpen={isOpen} onClose={onClose} isCentered style={{width: '700px'}}>
                    <ModalOverlay/>
                    <form onSubmit={handleSubmit}>
                        <ModalContent>
                            <ModalHeader>{isEditing ? "Contact Update" : "New Contact"}</ModalHeader>
                            <ModalCloseButton/>
                            <ModalBody pb={'6'}>
                                ...
                                <Flex mt={10} gap={5}>
                                    ...
                                    <FormControl isRequired>
                                        ...
                                        <Input type="number" value={phoneNumber} placeholder='phoneNumber'
                                ...
                                <FormControl isRequired mt={4}>
                                    ...
                                    <Input type='email' value={address} placeholder='email'
                                ...
                                <Flex style={{flexDirection: 'column'}}>
                                    <FormControl mt={4}>
                                        ...
                                        <Textarea placeholder='Hello here!' value={note} h={'10px'}
                                                  onChange={(e) => setNote(e.target.value)}
                                        />
                                    </FormControl>

                                    <Button mt={2} onClick={handleAddMessage} style={{float: "right"}}>Add Message</Button>
                                </Flex>
                            ...
                            <ModalFooter>
                                <Button colorScheme='blue' mr={3} type="submit" isLoading={isLoading}>{isEditing ? "Update" : "Save"}</Button>
                                <Button onClick={() => {
                                    onClose();
                                    setName("");
                                    setPhoneNumber("");
